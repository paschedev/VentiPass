  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="bg-neutral-900 border border-white/10 p-8 md:p-12 rounded-3xl w-full max-w-lg text-center shadow-2xl">
        ...
        <h1 className="font-outfit text-3xl font-bold text-white mb-4">Pago Pendiente</h1>
        <p className="text-neutral-400 mb-8 leading-relaxed">
          Tu pago está siendo procesado (por ejemplo, si usaste Rapipago o Pago Fácil). 
          Una vez que el saldo se acredite, tus entradas se generarán automáticamente.
        </p>
